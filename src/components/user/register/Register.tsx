        ...
        <div className="mx-auto flex flex-col max-w-7xl pt-20 items-center">
            <div className="w-3/6 bg-gray-50 px-20 py-4 drop-shadow-md">
                ...
                <form action="">
                    ...
                    <label className="block mb-6">
                        <button className="px-2  bg-azul border border-slate-300 w-full py-2 border-slate-200 placeholder-slate-400 contrast-more:border-slate-400 contrast-more:placeholder-slate-500">Registrar</button>
                    </label>
                </form>
            </div>
        </div>
